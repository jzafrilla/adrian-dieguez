    ...
    <footer id="contacto" style={{ backgroundColor: '#0a0a0a', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
      <div style={{ maxWidth: '80rem', margin: '0 auto', padding: '0 2rem' }}>
        ...
        <div style={{ padding: '5rem 0', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 250px), 1fr))', gap: '3rem' }}>
            ...
            <div className="flex gap-4">
              {data.social.instagram && (
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-[#1a1a1a] flex items-center justify-center text-gray-400 hover:bg-[#e63946] hover:text-white transition-all"
              ...
              {data.social.facebook && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full bg-[#1a1a1a] flex items-center justify-center text-gray-400 hover:bg-[#00d4ff] hover:text-white transition-all"
                  aria-label="Facebook"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="section-title text-white text-lg mb-6">NAVEGACIÓN</h4>
            <ul className="space-y-3">
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#e63946] hover:text-[#ff073a] transition-colors font-medium"
                >
                  Tienda Online →
                </a>
              </li>
          ...
          {/* Contact */}
          <div>
            <h4 className="section-title text-white text-lg mb-6">CONTACTO</h4>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-[#e63946] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
